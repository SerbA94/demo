...
public final class Fields {
	...
	public static final String USER__USER_ID = "user_id";
	...
	public static final String ROLE__ROLE_ID = "role_id";
	public static final String ROLE__TITLE = "role_title";

	public static final String BOOKING__BOOKING_ID = "booking_id";
	...
	public static final String IMAGE__IMAGE_ID = "image_id";
	...
	public static final String ROOM__ROOM_ID = "room_id";
	...
	public static final String ROOM_STATUS__ROOM_STATUS_ID = "room_status_id";
	public static final String ROOM_STATUS__TITLE = "room_status_title";

	public static final String ROOM_CLASS__ROOM_CLASS_ID = "room_class_id";
	public static final String ROOM_CLASS__TITLE = "room_class_title";

	public static final String DESCRIPTION__DESCRIPTION_ID = "description_id";
