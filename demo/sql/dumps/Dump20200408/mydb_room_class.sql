...
CREATE TABLE `room_class` (
  ...
  `room_class_title` varchar(20) NOT NULL,
  PRIMARY KEY (`room_class_id`),
  UNIQUE KEY `id_UNIQUE` (`room_class_id`),
  UNIQUE KEY `class_UNIQUE` (`room_class_title`)
...
INSERT INTO `room_class` VALUES (1,'budgetary'),(3,'business'),(2,'family'),(4,'luxury');
